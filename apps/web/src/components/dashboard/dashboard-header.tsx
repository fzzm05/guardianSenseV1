...
export function DashboardHeader({
  ...
  return (
    <header className="relative z-40 flex items-center justify-between gap-3 rounded-2xl border border-neutral-200/80 bg-white/95 px-3 py-2 shadow-[0_1px_3px_rgba(0,0,0,0.06),0_1px_2px_rgba(0,0,0,0.04)] backdrop-blur-xl dark:border-white/[0.07] dark:bg-neutral-950/95 dark:shadow-[0_1px_3px_rgba(0,0,0,0.3)]">
      ...
      <div className="flex shrink-0 items-center gap-2">
        ...
        {mounted && (
          <button
            ...
            className="flex h-7 w-7 items-center justify-center rounded-lg text-neutral-400 transition hover:bg-neutral-100 hover:text-neutral-700 dark:hover:bg-white/[0.06] dark:hover:text-neutral-200"
          >
            {theme === "dark" ? (
...
function TaskbarIcon({ routeId }: { routeId: (typeof routeItems)[number]["id"] }) {
  ...
  if (routeId === "activity") {
    return (
      <svg aria-hidden className={cls} fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24">
        <path d="M4 17h3.2l2.2-6 3.2 9 2.3-6H20" />
      </svg>
    );
  }
  if (routeId === "zones") {
