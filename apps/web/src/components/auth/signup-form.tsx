...
export function SignupForm() {
  ...
  return (
    <div className="flex w-full max-w-[380px] flex-col">
      <h1 className="text-[28px] font-semibold tracking-[-0.02em] text-neutral-900 dark:text-white">Create your account</h1>
      <p className="mt-1.5 text-[14px] text-neutral-500 dark:text-neutral-400">Start monitoring your children in minutes</p>

      <form className="mt-8 flex flex-col gap-5" onSubmit={handleSubmit}>
        {/* Email */}
        <div className="flex flex-col gap-1.5">
          <label htmlFor="signup-email" className="text-[13px] font-medium text-neutral-700 dark:text-neutral-300">
            Email
          </label>
          <input
            id="signup-email"
        ...
        {/* Password */}
        <div className="flex flex-col gap-1.5">
          <label htmlFor="signup-password" className="text-[13px] font-medium text-neutral-700 dark:text-neutral-300">
            Password
          </label>
      ...
      <p className="mt-6 text-center text-[13px] text-neutral-500">
        ...
        <Link href="/login" className="font-medium text-neutral-900 underline-offset-2 hover:underline dark:text-white">
          Sign in
        </Link>
      </p>

      <p className="mt-5 text-center text-[11.5px] leading-5 text-neutral-600 dark:text-neutral-500">
        By continuing, you agree to our{" "}
        <a href="#" className="underline underline-offset-2 text-neutral-900 dark:text-neutral-300">Terms of Service</a>
        {" "}and{" "}
        <a href="#" className="underline underline-offset-2 text-neutral-900 dark:text-neutral-300">Privacy Policy</a>.
      </p>
    </div>
  );
}
